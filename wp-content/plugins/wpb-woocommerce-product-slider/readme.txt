=== WPB Product Slider for WooCommerce - Product Carousel ===
...
= version 2.0.9.9 =
* Improved coding standards of the shortcode file.

= version 2.0.9.8 =
* Tested with WooCommerce 8.3.1 and WordPress 6.4.1

= version 2.0.9.7 =
* Added new settings for Priority Scripts Loading.

= version 2.0.9.6 =
* Disabled slider refresh in ajax complete.

= version 2.0.9.5 =
* Small issue fixed.

= version 2.0.9.4 =
* Slider refresh added on ajax complete and WC cart update
* Tested with WooCommerce 7.5.1and WordPress 6.2

= version 2.0.9.3 =
* Tested with WooCommerce 7.3.0 and WordPress 6.1.1

= version 2.0.9.2 =
* New shortcode parameter (image_size) added for image size.
...
= version 2.0.8.8 =
* Added the Advanced Product Labels for WooCommerce plugin support.
* Tested with WooCommerce 4.8.0 and WordPress 5.6

= version 2.0.8.7 =
* Arrow icons done with pure CSS only.
